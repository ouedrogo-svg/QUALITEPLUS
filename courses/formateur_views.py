...
def formateur_dashboard(request):
    """Accueil : catégories assignées uniquement, sans demandes d’abonnement."""
    ...
    return render(
        ...
        "courses/formateur/dashboard.html",
        {
            **_formateur_dashboard_context(
            ...
            "show_content_overview": False,
            "space_title": "Espace formateur",
            "space_intro": (
                "Catégories qui vous sont assignées par l’administrateur. "
                "Utilisez le menu pour gérer sujets, corrections et examens — "
                "sans abonnement candidat pour prévisualiser vos contenus."
            ),
        },
    )
    ...
    return render(
        ...
        "courses/formateur/dashboard.html",
        {
            **_formateur_dashboard_context(
            ...
            "space_intro": (
                "Catégories assignées par l’administrateur — consultation des contenus "
                "sans abonnement candidat."
            ),
        },
    )
